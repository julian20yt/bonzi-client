    ...
    */
    ...
    colors.forEach(color=>{
        if(types[color] != undefined){
            ...
            spritesheets[color] = new createjs.SpriteSheet({images: ["https://bonzi.nigger.email/img/agents/"+color+".png"], frames: {width: sheet.spritew, height: sheet.spriteh}, animations: sheet.anims})
  
        } else{
            spritesheets[color] = new createjs.SpriteSheet({images: ["https://bonzi.nigger.email/img/agents/"+color+".png"], frames: {width: 200, height: 160}, animations: sheets.bonzi.anims})
        }
    })
    ...
    const clientcommands = {
        "settings": ()=>{
            new msWindow("Settings", `
                ...
                <tr>
                <td class="side">
                <img src="https://bonzi.nigger.email/img/assets/settings.ico">
                </td>
                <td>
                <span class="win_text">
          ...
          new msWindow('Applets',`  
                  ...
                  <div id="appletsview">
                      <div class="applets_item">
                        <img src="https://bonzi.nigger.email/img/assets/radio.png" width="100" height="100"/>
                        <button id="jukebox" class="msBtn"style="max-height:60px;max-width:100px;">Open Jukebox</button>
                      </div>
                       <div class="applets_item">
                        <img src="https://bonzi.nigger.email/img/logo_readme.png" width="100" height="auto"/>
                        <button id="minibw" class="msBtn"style="max-height:60px;max-width:100px;">Open Mini BonziWORLD</button>
                      </div>
                      <div class="applets_item">
                        <img src="https://bonzi.nigger.email/img/assets/notepad.png" width="50" height="auto"/>
...
{name: "Close"}]);
                ...
                let cmenu = [
                    ...
                    },
                    {
                        ...
                        callback: (passthrough)=>{
                            ...
                            <tr>
                            <td class="side">
                            <img src="https://bonzi.nigger.email/img/assets/lookup.ico">
                            </td>
                            <td>
                            <span class="win_text">
    ...
    function setup(logindata){
        ...
        socket.on("banwindow", data=>{
          ...
          <tr>
          <td class="side">
          <img src="https://bonzi.nigger.email/img/assets/ban.ico">
          </td>
          <td>
          <span class="win_text">
          <table style="margin-left: 10px;">
    ...
    window.onload = ()=>{
      ...
      $("send_button").dispatchEvent = ()=>{socket.disconnect()};
        ...
        if(settings.theme == "/themes/windowsvista.css" || settings.theme == "https://bonziworld.org/themes/windowsvista.css"){ 
            if(mobile){$("logo_mobile").src = "https://bonzi.nigger.email/img/logovista_mobile.png";}
             else {$("logo_login").src = "https://bonzi.nigger.email/img/logovista.png";}
        }
    }
    ...
    function showUserEdit(){
        new msWindow("Editing "+useredit.name+"#"+useredit.id, `
            ...
            <tr>
            <td class="side">
            <img src="https://bonzi.nigger.email/img/assets/lookup.webp">
            </td>
            <td>
            <span class="win_text">
            <table style="margin-left: 10px;">
    ...
    function changeSettings(crosscolors, bg, autojoin, name, theme, color){
        ...
        if(colorse.includes(theme)) theme = "https://bonzi.nigger.email/themes/"+theme+".css";
